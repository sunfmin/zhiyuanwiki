...
func TestParseScores(t *testing.T) {
	...
	rows := [][]string{
		header,
		{"2025", "安徽大学", "1101", "物理类", "本科批", "人工智能", "（05）", "首选物理", "640", "1196"},
		{"2025", "安徽师范大学", "1102", "历史类", "本科批", "汉语言文学", "（01）", "首选历史", "610", "2300"},
...
func TestParsePlan(t *testing.T) {
	...
	rows := [][]string{
		header,
		{"2025", "安徽大学", "1101", "物理类", "本科批", "人工智能", "（05）", "首选物理", "30", "四年", "5800"},
...
func TestParseYiFenYiDuan(t *testing.T) {
	...
	got := parseYiFenYiDuan(sheet(t, rows, yfdHeader), "安徽", 2025)
	if len(got) != 2 { // 物理 + 历史
